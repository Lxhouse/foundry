    ...
    function getComponent(c: ComponentConfType<ComponentPropsType>) {
        ...
        function handleClick() {
            addComponents({
                ...
                title, isHidden: false, isLocked: false, type, props: defaultProps
            })
        }
        return <div key={type} className="mb-3 cursor-pointer bg-stone-100 border-2 border-solid border-white p-3 rounded hover:border-zinc-300" onClick={handleClick}>
